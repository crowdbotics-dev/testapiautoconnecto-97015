...
## Project Structure
    ...
    ├── testapiautoconnecto_97015  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_97015`
...
2. Clone this repo and `cd testapiautoconnecto_97015`
